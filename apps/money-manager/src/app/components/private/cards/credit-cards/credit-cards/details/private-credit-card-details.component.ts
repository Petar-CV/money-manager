...
@Component({
  selector: 'petar-cv-private-credit-card-details',
  templateUrl: './private-credit-card-details.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PrivateCreditCardDetailsComponent implements OnInit {
